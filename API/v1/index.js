...
const phb24 = {
 ...
 classes: [
  ...
  {
   identifier: "fighter",
   content: require('./json/phb24/classes/phb_24_fighter.json').class
  },
  {
   identifier: "monk",
   content: require('./json/phb24/classes/phb_24_monk.json').class
  }
 ],
 subclasses: [
  {
  ...
  {
   identifier: "fighter",
   content: require('./json/phb24/classes/phb_24_fighter.json').subclasses
  },
  {
   identifier: "monk",
   content: require('./json/phb24/classes/phb_24_monk.json').subclasses
  }
 ]
};
